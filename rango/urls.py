...
urlpatterns=[
    ...
    path('category/<slug:category_name_slug>/add_like_number_category/', views.add_like_number_category, name='add_like_number_category'),
    path('category//<slug:category_name_slug>/sub_like_number_category/', views.sub_like_number_category, name='sub_like_number_category'),
